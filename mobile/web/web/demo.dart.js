...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, _this, _this0, ctx;
      A.print("[Demo] Starting...");
      t1 = init.G;
      ...
      _this0 = A._asJSObject(A._asJSObject(t1.document).createElement("div"));
      A._asJSObject(_this0.style).padding = "8px";
      A._asJSObject(_this0.style).background = "#333";
      A._asJSObject(_this0.style).color = "#fff";
      A._asJSObject(_this0.style).fontFamily = "sans-serif";
      A._asJSObject(_this0.style).fontSize = "14px";
      _this0.textContent = "Canvas Demo";
      _this.append(_this0);
      _this0 = A._asJSObject(A._asJSObject(t1.document).createElement("canvas"));
      A._asJSObject(_this0.style).display = "block";
      A._asJSObject(_this0.style).width = "100%";
      A._asJSObject(_this0.style).height = "100%";
      _this.append(_this0);
      A.print("[Demo] Canvas created: " + A._asInt(_this0.clientWidth) + "x" + A._asInt(_this0.clientHeight));
      ctx = A._asJSObjectQ(_this0.getContext("2d"));
      if (ctx == null)
        ctx = A._asJSObject(ctx);
      _this0.width = 800;
      _this0.height = 600;
      A.print("[Demo] Canvas internal: " + A._asInt(_this0.width) + "x" + A._asInt(_this0.height));
      ctx.fillStyle = "rgb(255,0,0)";
      ctx.fillRect(0, 0, A._asInt(_this0.width), A._asInt(_this0.height));
      ...
      A.print("[Demo] Drawing complete");
      A.print("[Demo] Body: " + A.S(A._asJSObjectQ(A._asJSObject(t1.document).body)));
      A.print("[Demo] Done");
    }
  },
  B = {};
